...
async function ae(n, e) {
  ...
  }, r = e ? e(a) : a, i = ne() ? s.body : await s.blob();
  return new Response(i, r);
}
const re = (n) => new URL(String(n), location.href).href.replace(new RegExp(`^${location.origin}`), "");
function B(n, e) {
  const t = new URL(n);
  for (const s of e)
...
class V {
  ...
  handleAll(e) {
    ...
    const t = e.event, s = typeof e.request == "string" ? new Request(e.request) : e.request, a = "params" in e ? e.params : void 0, r = new le(this, { event: t, request: s, params: a }), i = this._getResponse(r, s, t), c = this._awaitComplete(i, r, s, t);
    return [i, c];
  }
...
p.copyRedirectedCacheableResponsesPlugin = {
  async cacheWillUpdate({ response: n }) {
    return n.redirected ? await ae(n) : n;
  }
};
class ue {
  /**
  ...
  addToCacheList(e) {
    ...
    for (const s of e) {
      ...
      const { cacheKey: a, url: r } = ee(s), i = typeof s != "string" && s.revision ? "reload" : "default";
...
let L;
const k = () => (L || (L = new ue()), L);
try {
  self["workbox:routing:7.0.0"] && _();
} catch {
}
const $ = "GET", E = (n) => n && typeof n == "object" ? n : { handle: n };
class g {
  /**
...
let y;
const pe = () => (y || (y = new fe(), y.addFetchListener(), y.addCacheListener()), y);
function C(n, e, t) {
  let s;
  if (typeof n == "string") {
...
function ye(n) {
  const e = k(), t = new we(e, n);
  C(t);
}
const _e = "-precache-", Re = async (n, e = _e) => {
...
function Ce(n) {
  return k().createHandlerBoundToURL(n);
}
function xe(n) {
  k().precache(n);
}
...
const Q = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), Y = /* @__PURE__ */ new WeakMap(), T = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakMap();
function Pe(n) {
  ...
  return e.then((t) => {
    t instanceof IDBCursor && Q.set(t, n);
  }).catch(() => {
  }), S.set(e, n), e;
}
function ke(n) {
...
function Se(n) {
  return n === IDBDatabase.prototype.transaction && !("objectStoreNames" in IDBTransaction.prototype) ? function(e, ...t) {
    ...
    return Y.set(s, e.sort ? e.sort() : [e]), f(s);
  } : Ue().includes(n) ? function(...e) {
    return n.apply(I(this), e), f(Q.get(this));
  } : function(...e) {
    return f(n.apply(I(this), e));
  };
}
function Ke(n) {
  return typeof n == "function" ? Se(n) : (n instanceof IDBTransaction && ke(n), Ie(n, Ne()) ? new Proxy(n, P) : n);
}
function f(n) {
  ...
  if (T.has(n))
    return T.get(n);
  const e = Ke(n);
  return e !== n && (T.set(n, e), S.set(e, n)), e;
}
const I = (n) => S.get(n);
...
const ve = ["get", "getKey", "getAll", "getAllKeys", "count"], Be = ["put", "add", "delete", "clear"], N = /* @__PURE__ */ new Map();
function F(n, e) {
...
const We = "workbox-expiration", R = "cache-entries", H = (n) => {
...
const He = 24 * 60 * 60, A = He * 7;
Ee([{"revision":null,"url":"assets/index-603e5a00.css"},{"revision":null,"url":"assets/index-66013e25.js"},{"revision":"c942bf041a96be7a19469aace7e3bd2e","url":"index.html"},{"revision":"1872c500de691dce40960bb85481de07","url":"registerSW.js"},{"revision":"c88e8fd79f6c6702ea3671e1de3441ee","url":"icon_32.png"},{"revision":"ed798a6fa7f92f4ded4736687c9ee6bc","url":"icon_32.webp"},{"revision":"44569e371f43307fcb0e5a94465688c5","url":"icon_48.png"},{"revision":"03df211c5373f269ec8dc19eaf34f3e9","url":"icon_128.png"},{"revision":"92912d5707c4bc422043679584a047ff","url":"icon_256.png"},{"revision":"81985703689478579894e646c46c4ec3","url":"manifest.webmanifest"}]);
be();
C(
